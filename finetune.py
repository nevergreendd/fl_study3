...
if __name__ == "__main__":
    ...
    elif config['task_name'] == 'merged':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'merged.csv'
        target_list = ["MLM"]

    elif config['task_name'] == 'ms_mouse':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'ms_mouse.csv'
        target_list = ["MLM"]

    elif config['task_name'] == 'dacon':
        config['dataset']['task'] = 'regression'
        config['dataset']['data_path'] = 'train_ori2.csv'
        target_list = ["MLM", "HLM"]
